...
INSERT INTO account (id, name, balance) VALUES (1, 'Alice Wonderland', 1000.00) ON CONFLICT (id) DO NOTHING;
INSERT INTO account (id, name, balance) VALUES (2, 'Bob The Builder', 500.00) ON CONFLICT (id) DO NOTHING;
INSERT INTO account (id, name, balance) VALUES (3, 'Charlie Brown', 750.00) ON CONFLICT (id) DO NOTHING;
INSERT INTO account (id, name, balance) VALUES (4, 'Diana Prince', 2000.00) ON CONFLICT (id) DO NOTHING;
INSERT INTO account (id, name, balance) VALUES (5, 'Edward Scissorhands', 100.00) ON CONFLICT (id) DO NOTHING;
